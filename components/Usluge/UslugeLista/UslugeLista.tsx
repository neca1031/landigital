  ...
  return (
    <UslugeHeroWrapper>
      <HeadingWrap>
        ...
        <UslugaSubHeading>
          Izrada veb-sajta, vođenje društvenih mreža ili oba?<br /> Šta god da tražite
          na pravom ste mestu.
        </UslugaSubHeading>
      </HeadingWrap>
      <UslugeContainer>
        ...
        <Usluga>
          ...
          <UslugaP>
            ...
            faktora za rast biznisa.
          </UslugaP>
        </Usluga>
        <Usluga>
          <UslugaIcon3></UslugaIcon3>
          <UslugaHeading>Marketing</UslugaHeading>
          <UslugaP>
            Kreiranje marketinških kampanja na društvenim mrežama ili na samom
            sajtu ume da predstavlja težak posao. Mi se trudimo da taj posao
            olakšamo i predstavimo Vaš biznis u najboljem svetlu.
          </UslugaP>
        </Usluga>
      </UslugeContainer>
    </UslugeHeroWrapper>
